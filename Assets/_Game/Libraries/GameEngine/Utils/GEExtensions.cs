...
namespace GameEngine.Library.Utils
{
    ...
    public static class TransformExtensions
    {
        ...
        */
        ...
        public static Vector3 GetX0Z(this Vector3 target)
        {
            return new Vector3(target.x, 0f, target.z);
        }

		public static Vector3 GetXY0(this Vector3 target)
		{
			return new Vector3(target.x, target.y, 0f);
		}

		public static Vector3 Get0YZ(this Vector3 target)
		{
			return new Vector3(0f, target.y, target.z);
		}

        public static Vector2 GetXZ(this Vector3 target)
        {
