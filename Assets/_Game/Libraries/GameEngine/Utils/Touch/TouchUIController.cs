...
namespace GameEngine.Library.Utils
{
    ...
    public class TouchUIController : Singleton<TouchUIController>, IPointerDownHandler, IPointerUpHandler, IPointerExitHandler, IPointerEnterHandler
    {
        ...
        private void SetTouchDefault()
        {
            ...
            InputAxis = inputAxis;
            InputNormalized = new Vector2(Mathf.Clamp01(Mathf.Abs(GEMaths.Normalize(InputDelta.x, 0f, MaximumInputNormalizedLength)))
                                        , Mathf.Clamp01(Mathf.Abs(GEMaths.Normalize(InputDelta.y, 0f, MaximumInputNormalizedLength))));
        }
        ...
        public virtual void OnPointerUp(PointerEventData data)
        {
            ...
            {
                _angle = GEMaths.AngleBetween(_deltaSwipe, Vector2.right);
