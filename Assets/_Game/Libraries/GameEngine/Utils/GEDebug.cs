...
namespace GameEngine.Library.Utils
{
	...
	public static class GEDebug
	{
		...
		/// <param name="color">Color.</param>
		/// <param name="size">Size.</param>
		public static void DrawCube(Vector3 position, Color color, Vector3 size, float duration = 0f)
		{
			if (!DebugDrawEnabled)
			{
				return;
		...
		public static void DrawPoint(Vector3 position, Color color, float size, float duraton = 0f)
		{
			if (!DebugDrawEnabled)
			{
				return;
			...
			Debug.DrawLine(points[0], points[1], color, duraton);
			Debug.DrawLine(points[2], points[3], color, duraton);
			Debug.DrawLine(points[4], points[5], color, duraton);
			Debug.DrawLine(points[0], points[2], color, duraton);
			Debug.DrawLine(points[0], points[3], color, duraton);
			Debug.DrawLine(points[0], points[4], color, duraton);
			Debug.DrawLine(points[0], points[5], color, duraton);
			Debug.DrawLine(points[1], points[2], color, duraton);
			Debug.DrawLine(points[1], points[3], color, duraton);
			Debug.DrawLine(points[1], points[4], color, duraton);
			Debug.DrawLine(points[1], points[5], color, duraton);
			Debug.DrawLine(points[4], points[2], color, duraton);
			Debug.DrawLine(points[4], points[3], color, duraton);
			Debug.DrawLine(points[5], points[2], color, duraton);
			Debug.DrawLine(points[5], points[3], color, duraton);
		}
...
#if UNITY_EDITOR
		public static void DrawGizmoText(string text, Vector3 worldPosition, Color? color = null)
		{
			if (color.HasValue)
