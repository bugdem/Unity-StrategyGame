...
namespace GameEngine.Utils
{
    ...
    {
        [MenuItem("Game Engine/UI/Anchors to Corners %[", priority = 1001)]
        ...
        [MenuItem("Game Engine/UI/Corners to Anchors %]", priority = 1002)]
        ...
        [MenuItem("Game Engine/UI/Mirror Horizontally Around Anchors %;", priority = 1003)]
		static void MirrorHorizontallyAnchors()
        {
            MirrorHorizontally(false);
        }

        [MenuItem("Game Engine/UI/Mirror Horizontally Around Parent Center %:", priority = 1004)]
        ...
        [MenuItem("Game Engine/UI/Mirror Vertically Around Anchors %'", priority = 1005)]
		static void MirrorVerticallyAnchors()
        {
            MirrorVertically(false);
        }

        [MenuItem("Game Engine/UI/Mirror Vertically Around Parent Center %\"", priority = 1006)]
